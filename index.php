    ...
    <main class="global-layout__contents contents-layout wrapper">
        ...
        <ul class="grid-list">
            ...
            <a href="#">
              <figure class="grid-list__item">
                ...
                <figcaption class="grid-list__caption">
                  Design / Cording / Direction / Marketing<br />
                  高齢者住宅紹介コーポレートコーポレートコーポレートコーポレートサイト
                </figcaption>
              </figure>
            </a>
          </li>
          ...
          <li>
            <a href="#">
              <figure class="grid-list__item">
                <div class="grid-list__image">
                  <img src="./images/works-grid-item-3.png" alt="制作物の画像" />
                  <div class="grid-list__mask"></div>
                </div>
                <figcaption class="grid-list__caption">高齢者住宅紹介コーポレートサイト</figcaption>
              </figure>
          ...
          <li>
            <a href="#">
              <figure class="grid-list__item">
                <div class="grid-list__image">
                  <img src="./images/works-grid-item-4.png" alt="制作物の画像" />
                  <div class="grid-list__mask"></div>
                </div>
                <figcaption class="grid-list__caption">高齢者住宅紹介コーポレートサイト</figcaption>
              </figure>
          ...
          <li>
            <a href="#">
              <figure class="grid-list__item">
                <div class="grid-list__image">
                  <img src="./images/works-grid-item-5.png" alt="制作物の画像" />
                  <div class="grid-list__mask"></div>
                </div>
                <figcaption class="grid-list__caption">高齢者住宅紹介コーポレートサイト</figcaption>
              </figure>
          ...
          <li>
            <a href="#">
              <figure class="grid-list__item">
                <div class="grid-list__image">
                  <img src="./images/works-grid-item-6.png" alt="制作物の画像" />
                  <div class="grid-list__mask"></div>
                </div>
                <figcaption class="grid-list__caption">高齢者住宅紹介コーポレートサイト</figcaption>
              </figure>
          ...
          <li>
            <a href="#">
              <figure class="grid-list__item">
                <div class="grid-list__image">
                  <img src="./images/works-grid-item-7.png" alt="制作物の画像" />
                  <div class="grid-list__mask"></div>
                </div>
                <figcaption class="grid-list__caption">高齢者住宅紹介コーポレートサイト</figcaption>
              </figure>
          ...
          <li>
            <a href="#">
              <figure class="grid-list__item">
                <div class="grid-list__image">
                  <img src="./images/works-grid-item-8.png" alt="制作物の画像" />
                  <div class="grid-list__mask"></div>
                </div>
                <figcaption class="grid-list__caption">高齢者住宅紹介コーポレートサイト</figcaption>
              </figure>
          ...
          <li>
            <a href="#">
              <figure class="grid-list__item">
                <div class="grid-list__image">
                  <img src="./images/works-grid-item.png" alt="制作物の画像" />
                  <div class="grid-list__mask"></div>
                </div>
                <figcaption class="grid-list__caption">高齢者住宅紹介コーポレートサイト</figcaption>
              </figure>
      ...
      <section class="about">
        <div class="about__image">
          <img src="images/rectangle-217.png" />
        </div>
